...
message error "SweDoMenu 6.2 kräver att man har minst version 3.1 eller högre av Utility.h.";
endif;
...
! Language Block
Default MORE__TX "[Fortsätt]";      ! Message displayed to indicate multipage
